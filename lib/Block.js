...
var BlockRules = {
  maxTimeOffset: 24 * 60 * 60, // How far block timestamps can be into the future
  ...
  checkPowFromTimestamp: 1394048078,
  lastPowVersion: 6
};
...
Block.getBlockValue = function getBlockValue(height, network) {
  ...
  var subsidy = 1500 * util.COIN;
  if (height < 1) {
  	subsidy = 25232976 * util.COIN;
  } else if (height >= 141350 && height < 141351) {
	subsidy = 2600000 * util.COIN;
  } else if (height > 14000 && height < 50000) {
	subsidy = 150 * util.COIN;
  } else if (height >= 50000 && height < 100000) {
	subsidy = 150 * util.COIN;
  } else if (height >= 100000 && height < 160000) {
	subsidy = 1.5 * util.COIN;
  }
